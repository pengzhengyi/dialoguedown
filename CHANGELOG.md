...
- **A Playbook tab in the report** — after Dialogue Graph, the report now shows the compiled
  ...
  covers, the way an editor does for any `$schema`-linked JSON. Blocks fold from the gutter as
  they do in the Source and Config editors. Beside it, the playbook's header,
