...
| [Namespace Layout](./Namespace%20Layout.md) | Proposed: an architecture rule capping how many types an assembly's root namespace may hold, so a layer cannot flatten into an unnamed list | Proposed |
