...
| [Enum Wire Names](./other/Enum%20Wire%20Names.md) | Implemented: pin every JSON enum wire name with a hand-written converter, so no shipped build needs a .NET 9+ package | Implemented |
