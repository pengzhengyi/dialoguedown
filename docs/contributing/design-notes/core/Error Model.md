...
> [Diagnostics and Validation](../diagnostics/Diagnostics%20and%20Validation.md) note is the
...
[CLI Diagnostic Rendering](../diagnostics/CLI%20Diagnostic%20Rendering.md) for the terminal
projection and [Diagnostics Overlay](../visualization/editor/Diagnostics%20Overlay.md) for the editor
one.
