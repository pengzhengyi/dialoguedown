...
> the [`IScriptCompiler`](../../core/Script%20Compiler%20Facade.md) seam; synthetic
...
> [Node Inspector](../graph/Live%20Visualization%20-%20Node%20Inspector.md)).
>
...
1. The visualizer wires the parser and transpiler **by hand** and never runs the
   ...
   [`IScriptCompiler`](../../core/Script%20Compiler%20Facade.md) seam already runs all three
...
[Desugar](../../core/Desugar.md) language (**desugared AST**, **default speaker**, **jump**).
...
[Jump to source](../graph/Live%20Visualization%20-%20Node%20Inspector.md) is about to land in. Navigation is instead conditional by the **one dirty document** rule
