...
> [dialogue graph](../../core/Dialogue%20Graph.md) — the compiler's final artifact — rendered
...
graph](../../core/Dialogue%20Graph.md) is the artifact a runtime actually walks, and it is
