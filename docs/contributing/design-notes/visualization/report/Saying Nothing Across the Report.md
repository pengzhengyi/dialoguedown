...
- **Tag capsules.** Resolved: every tag is drawn as one capsule wherever the report shows it,
  colored by kind with its identity in a leading dot — see [Tag Capsules](./Tag%20Capsules.md).
