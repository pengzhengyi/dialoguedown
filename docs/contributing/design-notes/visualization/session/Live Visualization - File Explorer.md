...
> [Cross-file jump resolution](../../language/Cross-File%20Jump%20Resolution.md) note defers
...
[cross-file jump](../../language/Cross-File%20Jump%20Resolution.md) note designs the compiler
...
- **Cross-file jump *resolution*.** Following a link *opens the target file*; it
  ...
  [linker](../../language/Cross-File%20Jump%20Resolution.md)'s job.
...
The vocabulary aligns with the [cross-file jump](../../language/Cross-File%20Jump%20Resolution.md)
...
- **Navigate-per-file, keeping the single-document model.** Opening a script
  ...
  superseded: the in-place swap shipped — see
...
4. **Explorer in the UI, project in the model.** The sidebar reads "Explorer"
   ...
   [cross-file jump](../../language/Cross-File%20Jump%20Resolution.md) note.
