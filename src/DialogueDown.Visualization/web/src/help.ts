...
const SOURCE_HELP = `
  ...
  <p><strong>Editor.</strong> Find with <kbd>⌘/Ctrl-F</kbd> and fold a section from the
     ...
     italic, strikethrough, quote, and unquote. <kbd>Tab</kbd> indents the line and
     <kbd>Shift-Tab</kbd> outdents it (in Live Edit); press <kbd>Esc</kbd> to move focus out of
     the editor. To learn more about how to use the editor, check out
