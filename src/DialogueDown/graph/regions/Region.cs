...
/// choice weaves back to the exit), the <see cref="Members"/> it spans, and the regions
/// <see cref="Children"/> nested within it. Each concrete kind — a scene, a block-control arm —
